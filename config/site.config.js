...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'admin@blowswind.cn',
  ...
  footer:
    'Powered by <a href="https://github.com/lyc8503/onedrive-cf-index-ng" target="_blank" rel="noopener noreferrer">onedrive-cf-index-ng</a>. Made with ❤ by blowswind.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: [],
  hiddenItems: ['Personal Vault', '个人保管库'],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/blowswind',
    },
  ],
